...
{
	// Navbar types.
	const TYPE_INVERSE = 'static-top navbar-mind';
	...
	*/
	...
	public function run()
	{
		...
		if ($this->collapse !== false)
		{
			...
			/*echo '<div class="navbar-header"> <a class="navbar-brand visible-xs" href="./"><span>LMI</span></a>
		...
		if ($this->collapse !== false)
		{
			$this->controller->beginWidget('bootstrap.widgets.TbCollapse', array(
				...
				'htmlOptions'=>array('class'=>'collapse navbar-collapse navbar-mind-collapse'),
			));
		}
