<?php
 ...
 $sql->select('a.Id, a.ChannelName As ChannelName, a.ChannelLogo As ChannelLogo')->from('yii_channel a')->leftjoin('yii_agency_channel b', 'a.Id=b.ChannelId')->leftjoin('yii_channel c', 'b.AgencyId=c.Id')->leftjoin('credential d', 'c.LoginId = d.LoginId')->where('b.Id is NULL')->order('rand()')->limit('4');
...
<?php
 ...
 foreach ($sql->queryAll() as $row) {
  ...
  echo CHtml::link('view all',array('site/subscribe'),array('class'=>'btn btn-small view view-all-unsubscribe'));
  echo "</div>";
